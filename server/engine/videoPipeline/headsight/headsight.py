...
exchange_in = conf["headsight_in_ex"]
type_exchange_in = conf["headsight_in_ex_type"]
queue_in = conf["headsight_in_q"]
exchange_out = conf["headsight_out_ex"]
queue_out = conf["headsight_out_q"]
