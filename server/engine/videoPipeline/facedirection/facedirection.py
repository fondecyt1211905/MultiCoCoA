...
exchange_in = conf["facedirection_in_ex"]
type_exchange_in = conf["facedirection_in_ex_type"]
queue_in = conf["facedirection_in_q"]
exchange_out = conf["facedirection_out_ex"]
queue_out = conf["facedirection_out_q"]
