...
exchange_in = conf["segmentator_in_ex"]
type_exchange_in = conf["segmentator_in_ex_type"]
queue_in = conf["segmentator_in_q"]
exchange_out = conf["segmentator_out_ex"]
queue_out = conf["segmentator_out_q"]
...
def main():
    ...
    def callback(ch, method, properties, body):
        ...
        if len(queue) == 3:
            ...
            frame_duration = round(1/(queue[x]["fps"]/queue[x]["chunk"]) * conf["doa_number_of_chunks"], 2)
